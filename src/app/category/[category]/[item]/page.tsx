    ...
    <main className="min-h-screen bg-[#fbfbfa] text-neutral-950">
      <div className="mx-auto grid w-full max-w-7xl gap-8 px-5 py-8 sm:px-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(360px,0.9fr)] lg:px-10">
        <div className="grid gap-5">
          ...
          <div className="relative min-h-[320px] overflow-hidden rounded-lg border border-neutral-100 bg-[#fffefe] shadow-sm sm:min-h-[460px]">
            <Image
        ...
        <section className="grid content-start gap-6">
          ...
          <dl className="grid overflow-hidden rounded-lg border border-neutral-100 bg-[#fffefe] shadow-sm">
            {itemData.item.itemprops.map((property) => (
              <div
                key={`${itemData.item.itemname}-${property.label}`}
                className="grid gap-1 border-b border-neutral-100 px-5 py-4 last:border-b-0 sm:grid-cols-[160px_1fr] sm:gap-4"
              >
